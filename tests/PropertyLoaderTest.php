...
use Remorhaz\UCD\Exception\InvalidPropertyRangeSetException;
use Remorhaz\UCD\Exception\PropertyFileNotLoadedException;
use Remorhaz\UCD\Exception\PropertyRangeSetNotFoundException;
...
class PropertyLoaderTest extends TestCase
{
    ...
    {
        $propertyLoader = new PropertyRangeLoader(__DIR__, ['a' => (object) ['b' => 'c']]);
    ...
    {
        $propertyLoader = new PropertyRangeLoader(__DIR__, ['a' => '/InvalidPropertyIndex.php']);
